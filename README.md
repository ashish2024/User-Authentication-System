The proposed system is a user authentication system in which will use Face authentication and QR code authorization for logging in. It will enhance the security of the
